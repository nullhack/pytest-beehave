...
* OC-5: one dot per line — AGREE | plugin.py:94 is the deepest chain
...
* OC-8: ≤2 instance variables per class — AGREE | StepsReporter: 1 (_config); HtmlStepsPlugin: 1 (_tests_root)
