"""Tests for features dir bootstrap subfolder creation story."""

import pytest


@pytest.mark.skip(reason="not yet implemented")
def test_features_dir_bootstrap_3a1f8c2e() -> None:
    """
...
@pytest.mark.skip(reason="not yet implemented")
def test_features_dir_bootstrap_b7d4e091() -> None:
    """
...
@pytest.mark.skip(reason="not yet implemented")
def test_features_dir_bootstrap_c2a53f7d() -> None:
    """
    Given: the features directory exists with no backlog, in-progress, or completed subfolders
    When: pytest is invoked
